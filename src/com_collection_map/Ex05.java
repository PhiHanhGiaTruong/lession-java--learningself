...
public class Ex05 {
	...
	private static Map<Employee, List<Employee>> mockTeams() {
		...
		List<Employee> slist = Arrays.asList(new Employee(21, "C", 30, 2), new Employee(12, "D", 10, 2));
		List<Employee> tlist = Arrays.asList(new Employee(31, "E", 10, 3), new Employee(12, "F", 10, 3));
